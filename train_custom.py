...
# Create compatibility layer for tensorflow.contrib.framework
try:
    from tensorflow.contrib.framework import arg_scope, add_arg_scope
except ImportError:
    # Fallback for TensorFlow 2.x
    def arg_scope(list_ops_or_scope, **kwargs):
        """Compatibility layer for arg_scope"""
        return tf.compat.v1.variable_scope(None, default_name="arg_scope")
